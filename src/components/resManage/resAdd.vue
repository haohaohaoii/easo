    ...
    >
        ...
        >
            ...
            <el-form-item label="上传文件:">
                <!-- <el-upload ref="pic" action="#" :on-change="getFile" :auto-upload="false">
                    ...
                    <div
                        ...
                        style="color:red"
                    >只能上传pdf/doc/docx/excel/rar/zip/ppt/文件</div>
                </el-upload>-->
...
export default {
    ...
    methods: {
        ...
        //         this.$alert('是否替换上次上传的文件?', '提示', {
        //         confirmButtonText: '确定',
        //             callback: action => {
        //                 this.$refs.pic.handleRemove(fileList[0])
        //                 this.$message({
        //                 type: 'success',
        //                 message: '替换成功'
        //                 });
        ...
        sureEditor() {
            ...
            this.$refs["ruleForm"].validate(valid => {
                ...
                if (valid) {
                    // let params={
                    //     file:_this.files,  //新闻来源
                    //     fileName: _this.ruleForm.resTitle,  //新闻标题
                    //     fileDesc:_this.ruleForm.resIntor,  //新闻类型
                    // }
                    ...
                    // _this.$api.resManage.addNews(formData,{headers: {"Content-Type": "multipart/form-data"}}).then(res=>{
                    //     debugger
                    //     if(res.data.code ==0){
                    //         console.log(res)
                    //         _this.$message({
                    ...
                    _this.$axios.post('http://172.16.23.14:8081/admin/file',formData,{
