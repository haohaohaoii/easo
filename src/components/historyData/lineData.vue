    ...
    methods: {
        ...
        changeCod(val){
            ...
            if(val){  //选中
                ...
                for(let j=0; j<this.options.legend.data.length; j++){
                    if(this.options.legend.data[j] == 'COD'){  //再删除name值
        ...
        changeZd(val){
            ...
            if(val){  //选中
                ...
                for(let j=0; j<this.options.legend.data.length; j++){
                    if(this.options.legend.data[j] == '总氮'){  //再删除name值
                        this.options.legend.data.splice(j,1);
                    }
                }
                for(let k=0; k<this.options.color.length; k++){
        ...
        changeAn(val){
            ...
            if(val){  //选中
                ...
                for(let j=0; j<this.options.legend.data.length; j++){
                    if(this.options.legend.data[j] == '氨氮'){  //再删除name值
                        this.options.legend.data.splice(j,1);
                    }
                }
                for(let k=0; k<this.options.color.length; k++){
        ...
        changeZl(val){
            ...
            if(val){  //选中
                ...
                for(let j=0; j<this.options.legend.data.length; j++){
                    if(this.options.legend.data[j] == '总磷'){  //再删除name值
                        this.options.legend.data.splice(j,1);
                    }
                }
                for(let k=0; k<this.options.color.length; k++){
        ...
        changePh(val){
            ...
            if(val){  //选中
                ...
                for(let j=0; j<this.options.legend.data.length; j++){
                    if(this.options.legend.data[j] == 'PH'){  //再删除name值
                        this.options.legend.data.splice(j,1);
                    }
                }
                for(let k=0; k<this.options.color.length; k++){
        ...
        changeLl(val){
            ...
            if(val){  //选中
                ...
                for(let j=0; j<this.options.legend.data.length; j++){
                    if(this.options.legend.data[j] == '流量'){  //再删除name值
                        this.options.legend.data.splice(j,1);
                    }
                }
                for(let k=0; k<this.options.color.length; k++){
